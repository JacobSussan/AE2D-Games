...
//-------------------------------------------------------------------
AE::DebugRenderer::DebugRenderer()
{
...
void AE::DebugRenderer::init()
{
	...
	glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, 
					sizeof(DebugVertex), (void*)offsetof(DebugVertex, position));
	//-----------------------------------
...
//-------------------------------------------------------------------
void AE::DebugRenderer::drawBox(glm::vec4& destRect, const Color_rgb8& color, float angle)
{
	int i = m_verts.size();
...
//-------------------------------------------------------------------
void AE::DebugRenderer::drawCircle(const glm::vec2& center, const Color_rgb8& color, float radius)
{
	...
	// set up indicies for indexed drawing
...
//-------------------------------------------------------------------
void AE::DebugRenderer::render(const glm::mat4& projectionMatrix, float lineWidth)
{
	m_program.use();
